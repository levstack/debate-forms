...
// Define your database URL directly (replace with your actual database URL)
const DATABASE_URL =
  "postgresql://postgres:postgres@localhost:5432/debate_forms";

// Create a Prisma client with Accelerate extension and direct URL
